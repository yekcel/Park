        ...
        <div class="row justify-content-center mb-4">
            <div class="col-12">
                ...
                <div class=" card bg-white">
                    <div class="card-header bg-primary text-white"><i class="fa fa-user-plus icon" style="padding-left: 2px;"></i>ایجاد کاربر جدید
                        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2">
                                <form action="{{'/users/NEWUser'}}" method="post" class="form-horizontal">
                                    {{ csrf_field() }}

...
@section('title')
    گزارش عملکرد سه ماهه واحد های فناور پیش رشد
@endsection
...
@section('content')
    ...
    <div class="card bg-light text-dark ">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-10">گزارش عملکرد سه ماهه واحد های فناور پیش رشد</div>
        ...
        <div class="card-body ">
            <div class="card bg-secondary text-white ">
                ...
                <div class="card-body ">
                    <form action="{{'/reports/fanavarPish'}}" method="post" class="form-inline">
                        {{ csrf_field() }}
                        <div class="container">
                            <div class="row">

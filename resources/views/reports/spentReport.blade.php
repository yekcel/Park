                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($spents as $spent)
                        ...
                        <tr class="text-center">
                            ...
                            <td><?php echo $i;  ?></td>
                            <td>{{$spent->doc_number?$spent->doc_number:'-'}}</td>
                            <td>{{$spent->subaction->name}}</td>
                            <td>{{$spent->subaction->subaction_code}}</td>
                            <td>{{$spent->cost->name}}</td>
                            <td>{{$spent->cost->cost_code}}</td>
                            <td>{{$spent->price?number_format($spent->price):0}}</td>
                            <td>{{$spent->credit?$spent->credit->name:null}}</td>
                            <td>{{$spent->credit?$spent->credit->credit_code:null}}</td>
                            <td>

                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#exampleModalLong<?php echo $spent->id; ?>">اطلاعات هزینه
                                </button>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><span class="accent">تاریخ هزینه: </span>{{$spent->spend_date?Verta::instance($spent->spend_date)->formatJalaliDate():null}}</p>
                                                <p><span class="accent">سال هزینه: </span>{{$spent->year}}</p>
                                                <p><span class="accent">مبلغ هزینه: </span>{{number_format($spent->price)}}</p>
                                                <p><span class="accent">برنامه: </span>{{$spent->subaction->name}}</p>
                                                <p><span class="accent">فعالیت: </span>{{$spent->subaction->action->name}}</p>
                                                <p><span class="accent">ریزفعالیت: </span>{{$spent->subaction->action->application->name}}</p>
                                                <p><span class="accent">عنوان هزینه: </span>{{$spent->name}}</p>
                                                <p><span class="accent">موضوع هزینه: </span>{{$spent->cost->name}}</p>
                                                <p><span class="accent">سال هزینه: </span>{{$spent->year}}</p>
                                                <p><span class="accent">توضیحات: </span>{{$spent->comments}}</p>
                                                              </div>

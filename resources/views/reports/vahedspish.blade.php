...
@section('title')
    گزارش عملکرد واحد های فناور پیش رشد
@endsection
...
@section('content')
    ...
    <div class="card bg-light text-dark ">
        <div class="card-header bg-primary text-white" style="background: linear-gradient(90deg,#2991f6,#041a39); ">
            <div class="row">
                <div class="col-sm-10"><h5><i class="fa fa-file-text icon" style="padding-left: 2px;"></i> گزارش عملکرد واحد های فناور پیش رشد</h5></div>
        ...
        <div class="card-body ">
            <div class="card bg-secondary text-white " style="background-color:#798696; margin-bottom: 5px; ">
                ...
                <div class="card-body ">
                    <form action="{{'/reports/pishreport'}}" method="post" class="form-inline">
                        {{ csrf_field() }}
                        <div  style="width: 100%">
                            <div class="row">
                                <div class="col-md-10">
                ...
                <div class=" card-footer ">
                    <div class=" float-left">
                        <form action="{{'/reports/vahedspishExport'}}" method="post" class="form-inline">
                            {{ csrf_field() }}
